...
#define WWWDISKPATH "/home/httpd/download/"
#define TARWORKPATH "/home/httpd/download/tar/"
#define TRASHPATH "/home/httpd/download/tmp/"
...
void convertBoard(char *strBoardName){
	...
	FILE *indexFile;
        ...
        int length;        //added by wlm(2003-03-29)
...
{		convertDir(intArrDirsHead); intArrDirsHead++;}   //modified my wlm(2003-03-29)
       
         length=strlen(TARWORKPATH)+strlen(DOTINDEX);  //added by wlm(2003-03-29)
                                                     //determine the practical length of strBuf
